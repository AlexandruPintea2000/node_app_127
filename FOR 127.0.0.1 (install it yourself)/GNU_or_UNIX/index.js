...
// LOCAL DB // mongoose.connect('mongodb://127.0.0.1/db');
mongoose.connect('mongodb+srv://apaluza3:123parola123@cluster0.tj8nvpb.mongodb.net/db');


// mongoose.connect('mongodb://adminuser:123456@127.0.0.1/mydb'); - MAYBE FOR THE CLSTR
...
io.on('connection', (socket) => {
  ...
  socket.on('msg', ({discussion_id, text, r, user}) => {
    ...
    request.post(
        'http://127.0.0.1:8081/messages/create_message_socket',
  ...
  //   request.post(
  //       'http://127.0.0.1:8081/messages/get_r',
  //       { json: { } },
  //       function (error, res, body) {
  //           // if ( error )
  //           //     console.log(error);
...
//     request.post(
//         'http://127.0.0.1:8081/messages/get_user',
...
//     request.post(
//         'http://127.0.0.1:8081/messages/file_upload',
