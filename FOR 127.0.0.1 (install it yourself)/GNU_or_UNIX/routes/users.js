...
var email_text = "<div style='font-size:25px;'>Go to <b>http://127.0.0.1:8081/users/verif_rand:" + rand_verifier + '!' + username + "</b> to verify your account<br><br>Thank you!</div>";
...
router.post('/edit', User.ensureAuthenticated, function(req,res){
 ...
 var u = await User.getUserByUsername(req.body.username) // check the database for a user with the newly updated username
  ...
  if ( req.body.email != prev_email ) // if a new email was entered, send the user an email verification to the new email
  {
    ...
    var email_text = "<div style='font-size:25px;'>Go to <b>http://127.0.0.1:8081/users/verif_rand:" + rand_verifier + '!' + req.body.username + "</b> to verify your account<br><br>Thank you!</div>";
